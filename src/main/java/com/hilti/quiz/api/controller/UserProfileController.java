...
public class UserProfileController {
	...
	public @ResponseBody Success onUpdate(int empid,String password,String displayPic,String firstName,String lastName,String middleName,String department,String asOfDate,String email){
	    ...
	    return new Success("yes "+UserProfile.class.getName().substring(UserProfile.class.getName().lastIndexOf(".")+1)+" record created");
	...
	public @ResponseBody Success onDelete(int userProfileid){
	    ...
	    return new Success("yes "+UserProfile.class.getName().substring(UserProfile.class.getName().lastIndexOf(".")+1)+" record deleted");
